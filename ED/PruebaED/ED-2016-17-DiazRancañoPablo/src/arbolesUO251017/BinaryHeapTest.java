...
//	@Test
	...
	{	//Sacar elemento de árbol vacío (devuelve null)
		assertNull(bH.poll());
...
//	@Test
	public void testClear()
	{
		...
		bH.clear();
		assertTrue(bH.isEmpty()); //¿Cola vacía? Sí.
		
		assertEquals(-1, bH.search(3));
		assertEquals(-1, bH.search(12)); //No encuentra los nodos. Están borrados.
		
		System.out.println(bH.toString()); //Cola vacía.
