...
//		}
	...
	public T poll() 
	{
		...
		numElementos--; //Elimina el último nodo del vector.
	...
	public boolean remove(T info) 
	{
		...
		{
			elementos[posicionNodo] = elementos[numElementos - 1]; //El nodo a borrar se cambia por el último
																	//nodo del array (distinto a la teoría)
			
			cribaAscendente(posicionNodo);
			cribaDescendente(posicionNodo); //Reubicamos el nodo, mirando si puede subir o bajar en el árbol.
			
			numElementos--; //Se elimina el último nodo.
