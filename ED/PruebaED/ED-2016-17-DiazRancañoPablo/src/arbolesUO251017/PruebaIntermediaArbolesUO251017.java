...
public class PruebaIntermediaArbolesUO251017 {
	...
	public void test_3_RotacionesSimplesIzquierdaRemoveHijoDesequilibrado () 
	{
		...
		//Si se borra el nodo n6, el nodo n5 tendrá un BF de -2, por lo tanto debería hacer una rotación
		//simple izquierda.
		assertTrue(arbolAVL.remove(n6));
		System.out.println(arbolAVL.toString());
		
		//Se añade otro nodo como hijo izquierdo de n2, y se borra el nodo derecho de
		//la raíz (n5)
	...
	public void test_3_RotacionesSimplesDerechaRemoveHijoDesequilibrado () 
	{
		...
		//Si se borra el nodo n3, el nodo n5 tendrá un BF de 2, por lo tanto debería hacer una rotación
		//simple derecha.
		assertTrue(arbolAVL.remove(n3));
		System.out.println(arbolAVL.toString());
		
		//Se añade otro nodo como hijo derecho de n7, y se borra el nodo izquierdo de
		//la raíz (n5)
		assertTrue(arbolAVL.add(n8));
		assertTrue(arbolAVL.remove(n5));
		System.out.println(arbolAVL.toString());
		
		//Añadimos, finalmente, otro nodo como hijo derecho de n8 (n9), y borramos
		//el nodo izquierdo de la raíz (n6)
		assertTrue(arbolAVL.add(n9));
		assertTrue(arbolAVL.remove(n6));
		System.out.println(arbolAVL.toString());
	}
	...
	{
		//Añadimos nodos al árbol AVL, de tal forma que la raíz (10) tenga dos hijos y, a su vez, su
		...
		//Si borramos el nodo n12, el árbol quedaría desequilibrado. Se necesitaría hacer una rotación doble IZQUIERDA.
		assertTrue(arbolAVL.remove(n12));
		
		System.out.println(arbolAVL.toString());
		
		//Añadimos nodo a la derecha de n1, y borramos el n10 (rotación doble izquierda tras borrado)
		assertTrue(arbolAVL.add(n3));
		assertTrue(arbolAVL.remove(n10));
		
		System.out.println(arbolAVL.toString());
		
		//Añadimos nodo a la derecha de n1, y borramos el n4 (rotación doble izquierda tras borrado)
		assertTrue(arbolAVL.add(n2));
	...
	public void test_3_RotacionesDoblesDerechaRemove () 
	{
		...
		//Añadimos nodo a la izquierda de n10, y borramos el n4 (rotación doble derecha tras borrado)
		assertTrue(arbolAVL.add(n6));
		assertTrue(arbolAVL.remove(n4));
		
		System.out.println(arbolAVL.toString());
		
		//Añadimos nodo a la izquierda de n5, a la izquierda de n10, y borramos el subarbol
		//izquierdo de n6 (rotación doble derecha tras borrado).
		assertTrue(arbolAVL.add(n4));
		assertTrue(arbolAVL.add(n9));
	...
	{
		//Añadimos nodos al árbol AVL, de tal forma que la raíz (15) tenga dos hijos y, a su vez, su
		...
		//Borramos el n20. En este punto, según la teoría, se opta por una rotación simple (en este caso
		//, izquierda)
		assertTrue(arbolAVL.remove(n20));
		
		System.out.println(arbolAVL.toString());
		
		//Borramos un nodo para dejar a la raíz equilibrada, y añadimos dos nodos al subárbol izquierdo.
		assertTrue(arbolAVL.remove(n10));
		Integer n2neg= -2;
		assertTrue(arbolAVL.add(n2neg));
		assertTrue(arbolAVL.add(n2));
		
		//Borramos el nodo del subárbol derecho. Rotación simple izquierda.
	...
	public void test_3_RotacionesSimplesDerechaHijoEquilibrado () 
	{
		...
		//Borramos el n3. En este punto, según la teoría, se opta por una rotación simple (en este caso
		//, derecha)
		assertTrue(arbolAVL.remove(n3));
		System.out.println(arbolAVL.toString());
		
		//Borramos un nodo para dejar a la raíz equilibrada, y añadimos dos nodos al subárbol derecho
		assertTrue(arbolAVL.remove(n5));
		assertTrue(arbolAVL.add(n12));
		assertTrue(arbolAVL.add(n20));
		
		//Borramos el nodo del subárbol izquierdo. Rotación simple derecha.
		assertTrue(arbolAVL.remove(n4));
		System.out.println(arbolAVL.toString());
